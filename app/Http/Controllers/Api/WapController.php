...
class WapController extends Controller
{
    ...
    public function getCode()
    {
        ...
        $h5AuthUrl = sprintf($this->wechat['wap_code_url'], $this->wechat['app_id'], urlencode('http://www.zhumengyang.com/api/wap/callback'));

        \Log::info('微信第三方网页授权的地址', ['h5_url' => $h5AuthUrl]);

        heaader('location:'.$h5AuthUrl);
