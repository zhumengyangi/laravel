...
@section('pageHeader')
    <div class="pageheader">
        <h2><exporti class="fa fa-home"></exporti> 商品列表 <span>Subtitle goes here...</span></h2>
                ...
                <table class="table table-primary  mb30">
                    <thead>
                        ...
                        <tr v-for="goods in goods_list">
                            ...
                            <td>
                                <button class="btn btn-sm btn-success" v-if="goods.status== 2 " @click="changeAttr(goods.id,'is_new', 1)">已审核</button>
                                <button class="btn btn-sm btn-black" v-else @click="changeAttr(goods.id,'status', 2)">未审核</button></td>
                            <td>
                                <a class="btn btn-sm btn-primary" :href="'/admin/goods/sku/edit/'+goods.id">SKU属性</a>
