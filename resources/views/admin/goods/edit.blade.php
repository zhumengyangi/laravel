        ...
        <div class="panel-body panel-body-nopadding" v-show="tab==1">
                        ...
                        <select class="form-control" name="cate_id">
                            @if(!empty($cate_list))
                                @foreach($cate_list as $cate)
                                    <option value="{{$cate['id']}}" {{$info->cate_id == $cate['id'] ? "selected" : ""}}>
                                        {{str_repeat('>>',$cate['level'])}}{{$cate['cate_name']}}
                                    </option>
                                @endforeach
                            @endif
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="radio"><label><input  type="radio" name="is_new" value="2" {{$info->is_new == 1 ? "checked" : "" }}>否</label></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="radio"><label><input  type="radio" name="is_hot" value="2" {{$info->is_hot == 1 ? "checked" : "" }}>否</label></div>
                    </div>
        ...
        <div class="panel-body panel-body-nopadding" v-show="tab==3">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-2" v-for="gall in gallery_list">
                        ...
                        <p style="text-align: center"><button class="btn btn-xs btn-danger" @click="delGoodsGaller(gall.id)"><i class="glyphicon glyphicon-minus"></i></button> </p>
                    </div>
                </div>
                     <!-- 相册添加表单-->
                        <div class="form-group">
