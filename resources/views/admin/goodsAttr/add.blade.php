        ...
        <div class="panel-body panel-body-nopadding" id="attr_add">
            ...
            <form class="form-horizontal form-bordered" action="/admin/goods/attr/store" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="radio"><label><input @click="changeType" data-id="1" type="radio" name="input_type" value="1" checked> 手动输入</label></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                                                                                                        {{--    disabled不可选 --}}
                        <textarea class="form-control" cols="30" rows="5" name="attr_value" v-if="input_type == 1" disabled></textarea>
                        <textarea class="form-control" cols="30" rows="5" name="attr_value" v-else></textarea>
                    </div>
                </div>
                <div class="form-group">
